...
public class LongestPathFromStartLengthAnalyzer extends Analyzer {
    public LongestPathFromStartLengthAnalyzer() {
        super();
    }
    ...
    public double generatorAnalysis(Generator generator, int mazeSize) {
        ...
        return mazeGraph.getLongestPathFromStartLength();
    }
}
